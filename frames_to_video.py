...
# *** CONFIGURATION ***
# Indiquez le dossier contenant vos frames éditées
# FRAMES_DIR = "output/propagation-bta"  # À adapter selon votre dossier
FRAMES_DIR = "test-data"
OUTPUT_VIDEO = "output_video_test_data.mp4"
FPS = 15 # Frames par seconde
# ***

# Trouver toutes les images PNG/JPG dans le dossier
